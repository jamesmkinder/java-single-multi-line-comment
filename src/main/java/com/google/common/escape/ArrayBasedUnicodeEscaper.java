...
public abstract class ArrayBasedUnicodeEscaper {
    ...
    protected ArrayBasedUnicodeEscaper() {
        /*his is a bit of a hack but lets us do quicker per-character checks in
    ...
    //This is overridden to improve performance. Rough benchmarking shows that this almost doublesthe speed when processing strings that do not require any escaping.public final String escape(String s) {
        return s;
    }
